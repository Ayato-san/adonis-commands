import type { AbstractBaseCommand, CommandMetaData } from '@adonisjs/core/types/ace'
import { readFile } from 'node:fs/promises'

/**
 * In-memory cache of commands after they have been loaded
 */
let commandsMetaData: CommandMetaData[]
 ...
 * metadata
 */
export async function getCommand<Command extends AbstractBaseCommand>(
